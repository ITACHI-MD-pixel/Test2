...
async function syncdb() {
  ...
  let AstaConn = AstaConnectSock({
    ...
    browser: ["Windows", "chrome", "ITACHI-MD-pixel-V2"],
  ...
  AstaConn.messageId = (length = 8, prefix = "ITACHI-MD-pixel-V2") => {
...
app.listen(randomPort, () =>
  console.log(
    "ITACHI-MD-pixel-V2 Server listening on http://localhost:" + randomPort + "/ "
  )
);
