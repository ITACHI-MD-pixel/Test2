...
`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am ITACHI-MD-pixel-V2 whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "ITACHI-MD-pixel-V2-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     } catch (_0x3537cb) {
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "ITACHI-MD-pixel-V2 tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *ITACHI-MD-pixel-V2 • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 smd({
   ...
   try {
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "ITACHI-MD-pixel-V2--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("ITACHI-MD-pixel-V2 • SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ITACHI-MD-pixel-V2 • YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ITACHI-MD-pixel-V2 • APK DOWNLOAD LIST")) {
