const {
  ...
  smd({
    ...
    try {
      ...
      const astro = "ITACHI-MD-pixel-V2 ɢᴘᴛ𝟺\n";
      const tbl = "```";
  ...
  smd({
    ...
    try {
      ...
      const { result } = res;
      const astro = "ITACHI-MD-pixel-V2 ɢᴇᴍɪɴɪ ᴀɪ"
      const tbl = "```";
  ...
  smd(
    ...
    async (_0x1c0160, _0x482db1) => {
        let astro = "ITACHI-MD-pixel-V2 ᴄʜᴀᴛ ʙᴏᴛ"
      try {
    ...
    async (_0x358984, _0x20693a, { smd: _0x12d243 }) => {
      try {
        ...
        if (_0x48975a[0]) {
          ...
          _0x5f656f =
            "*ITACHI-MD-pixel-V2ᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " +
            _0x3079e2.id +
            "\n*Date:* _" +
            _0xbcd286 +
            "_\n*Time:* _" +
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("ITACHI-MD-pixel-V2• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("ITACHI-MD-pixel-V2 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*ITACHI-MD-pixel-V2 • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
