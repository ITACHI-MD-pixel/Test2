let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `ITACHI-MD-pixel-V2 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VafgKHuDjiOa7y21kq37\n\n ${Config.botname} *©Paul Adedokun*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*ITACHI-MD-pixel-V2 CURRENTLY ACTIVE!*";
 ...
 let tmpUrl = "https://telegra.ph/file/fb53ee55f85093b4b4eef.jpg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
