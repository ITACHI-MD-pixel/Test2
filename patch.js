...
${menuThemeFooter}                         
*┌┤✑  Thanks for Choosing ITACHI-MD-pixel-V2
│└────────────┈ ⳹        
  ...
  async (_0x22514a) => {
    try {
      let _0x20ed34 = (
        ...
        "/" +
        formatp(os.totalmem()) +
        "\n\n *🧑‍💻 :*  ITACHI-MD-pixel-V2 ɪꜱ ɴᴏᴡ Aᴠᴀɪʟᴀʙʟᴇ\n\n" +
        readmore +
        "\n╭──❰ *ALL MENU* ❱\n│🏮 Lɪꜱᴛ\n│🏮 Cᴀᴛᴇɢᴏʀʏ\n│🏮 Hᴇʟᴘ\n│🏮 Aʟɪᴠᴇ\n│🏮 Uᴘᴛɪᴍᴇ\n│🏮 Wᴇᴀᴛʜᴇʀ\n│🏮 Lɪɴᴋ\n│🏮 Cᴘᴜ\n│🏮 Rᴇᴘᴏꜱɪᴛᴏʀʏ\n╰─────────────⦁"
      ).trim();
    ...
    try {
      ...
      const designs = [
        async () => {
          ...
          const captionText = `ITACHI-MD-pixel-V2 1.𝟶.𝟶 ᴘᴀᴛᴄʜ\n\n*Ping:* ${pingSeconds} seconds${quoteText}\n\nITACHI-MD-pixel-V2`;
...
smd(
  ...
  async (m) => {
    try {
      ...
      const message = `*ITACHI-MD-pixel-V2 ʀᴜɴɴɪɴɢ sɪɴᴄᴇ:* ${uptimeHours}h ${uptimeMinutes}ᴍ ${uptimeSeconds}s\n \t_ʜᴇʀᴇ's ᴍᴏʀᴇ ɪɴғᴏ_\n*ʀᴀᴍ ᴜsᴀɢᴇ:* ${ramUsage.toFixed(2)} MB\n*ᴄᴘᴜ ɴᴀᴍᴇ:* ${cpuModel}`;
      const contextInfo = {
        isForwarded: true,
        forwardingScore: 999,
        title: "ITACHI-MD-pixel-V2 Running Since",
        body: message,
        footerText: "ITACHI-MD-pixel-V2 2024",
...
astro_patch.cmd({
    ...
    try {
      ...
      let _0x95885d = "\n\t*ITACHI-MD-pixel-V2 ᴄᴏᴍᴍᴀɴᴅs ɪɴғᴏ*  \n";
    ...
    try {
      ...
      if (!isNaN(_0x56b5d3)) {
        if (
          ...
          _0x1eb88a[1][_0x210c92(362)]("ITACHI-MD-pixel-V2_FANCY_TEXT")
        ) {
